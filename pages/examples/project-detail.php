...
if(isset($_GET['id']) && !empty(trim($_GET['id'])))
{
	...
	if ($stmt && $stmt_budget)
	{
		...
		{
			if($stmt -> rowCount() == 1 && $stmt_budget -> rowCount() == 1)
			{
				...
				<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
					...
					<li class="nav-item menu-open">
						...
						<ul class="nav nav-treeview">
							...
							<li class="nav-item">
								<a href="./project-detail.php" class="nav-link active">
									<i class="far fa-circle nav-icon"></i>
									<p>Project Detail</p>
								</a>
							</li>
				...
				<div class="row mb-2">
					...
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="./projects.php">Home</a></li>
						...
						<div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
							...
							<div class="text-muted">
								<p class="text-sm">Client Company
									<b class="d-block"><?php echo $row['ClientCompany']; ?></b>
								</p>
								<p class="text-sm">Project Leader
									<b class="d-block"><?php echo $row['ProjectLeader']; ?></b>
								</p>
							</div>
							...
							<ul class="list-unstyled">
								<li>
									...
									{
										echo "<p class=\"text-danger\" style=\"background-color: #f8d7d1\">No Records Found!</p>";
									}
									?>
								</li>
							</ul>
							<div class="text-center mt-5 mb-3">
								<a href=<?php echo "./project-edit.html?id=" . $id; ?> class="btn btn-sm btn-info">Edit this Project</a>
